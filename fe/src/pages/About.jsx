          ...
          <div className="hero-content">
            <div className="hero-icon">
              <svg width="80" height="80" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2">
                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm0-14c-3.31 0-6 2.69-6 6s2.69 6 6 6 6-2.69 6-6-2.69-6-6-6zm0 10c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4zm0-6a2 2 0 100 4 2 2 0 000-4z"/>
              </svg>
            </div>
            <h1>About Hami Kissan</h1>
            <p>Empowering farmers with cutting-edge technology for sustainable agriculture</p>
            <button className="button primary hero-cta">Explore Our Solutions</button>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="story-content">
            <div className="story-text">
              <p>
                Launched in 2025, <strong>Hami Kissan</strong> was born from a passion to revolutionize farming. Our mission is to empower farmers with real-time insights and tools to enhance productivity and sustainability.
              </p>
              <p>
                From a hackathon spark, we’re growing into a leading agri-tech platform, supporting thousands with AI-driven crop management, weather forecasts, and sustainable practices. Our vision is to make modern agriculture accessible to all farmers.
              </p>
            </div>
        ...
        <div className="container">
          ...
          <div className="metrics-grid">
            <div className="metric-card">
              <svg className="metric-icon" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#4caf50">
        ...
        <div className="container">
          ...
          <div className="team-grid">
            <div className="team-member">
              <svg className="member-avatar" width="80" height="80" viewBox="0 0 24 24" fill="none" stroke="#4caf50">
                <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/>
              </svg>
              <h3>Shital Gautam</h3>
              <p className="member-role">Team Member</p>
              <p className="member-bio">Frontend developer with 3+ years in React</p>
            </div>
            <div className="team-member">
              <svg className="member-avatar" width="80" height="80" viewBox="0 0 24 24" fill="none" stroke="#4caf50">
                <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/>
              ...
              <p className="member-role">Team Member</p>
              <p className="member-bio">Python Developer specializing in NumPy</p>
            </div>
            <div className="team-member">
              <svg className="member-avatar" width="80" height="80" viewBox="0 0 24 24" fill="none" stroke="#4caf50">
                <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/>
        ...
        <div className="container">
          ...
          <div className="values-grid">
            <div className="value-card">
              <svg className="value-icon" width="50" height="50" viewBox="0 0 24 24" fill="none" stroke="#4caf50">
